			    ...
			    <div class="content">
				  ...
				  ?>
			         <form id="login1" name="login1" method="post" action="index.php">
			        	<div class="checkout-item billing-address">
			              ...
			              <p>
		                   ...
		                   <input type="submit" value="Login" class="submit-btn custom-font-1" style="margin:50px 0px 25px 150px; ">
                        </div>
                     ...
                     <form id="register" name="register" method="post" action="register.php">
		              ...
		              <input type="submit" value="Register" class="submit-btn custom-font-1" style="margin:25px 0px 25px 150px; ">
                    </div>
			          <div class="clear"></div>
