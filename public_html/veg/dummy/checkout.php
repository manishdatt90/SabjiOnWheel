			      ...
			      <form name="frmCheckOut" id="frmCheckOut" action="process_checkout.php" method="POST">
			       <div class="checkout-item contact-email">
			          <div class="main-title">
                        ...
                        <a class="continue" href="vegetables.html">Return to store</a>
		              </div>
			          ...
			          <div class="items">
                       ...
                       <p class="checkbox">
                          ...
                          <select name="shippingTimeSlot" id="shippingTimeSlot" class="input-text-1">
                            ...
                            <option value="9am-12pm" <?=$shippingTimeSlot=='9am-12pm'?'selected="selected"':''?>>9am-12pm</option>
                            <option value="12pm-3pm" <?=$shippingTimeSlot=='12pm-3pm'?'selected="selected"':''?>>12pm-3pm</option>
                            <option value="4pm-6pm" <?=$shippingTimeSlot=='4pm-6pm'?'selected="selected"':''?>>4pm-6pm</option>
                            <option value="6pm-9pm" <?=$shippingTimeSlot=='6pm-9pm'?'selected="selected"':''?>>6am-9pm</option>                           
                          </select>
                        </p>
                       <p>
