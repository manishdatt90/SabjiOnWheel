    ...
    <div class="footer-inner">
      ...
      <div class="footer-bar">
        <ul>
          ...
          <li><a href="<?=$site_url?>/recipe.php">RECIPE</a></li>
          <li><a href="<?=$site_url?>/offer.php">OFFERS</a></li>
        </ul>
<div class="fb-like" data-href="https://www.facebook.com/sabjionwheels" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>


      </div>
    </div>
     <div class="copyright">
<strong>Promote by <a href="http://www.seotechexperts.in/" target="_blank">SEO Tech Experts</a></strong>
