...
<div class="topbar">
  <div class="topbar-inner">
    <div class="social-area">
      <div class="icons"><a href="/cart.php">Cart</a></div>
...
<li>
          <input type="submit" value="About Us" onClick="window.location.href='<?=$site_url?>/AboutUs.php'"/>
        </li>
       ...
       <li>
          <input type="submit" value="Offers" onClick="window.location.href='<?=$site_url?>/offer.php'"/>
        </li>
...
<div class="topbar-content">
  <div class="inner">
   ...
   <span style="font-size:18px;font-family:Cooper Black; color:white;">~~~ Register today and get 5% discount on your first order ~~~Discounts will be applied manually at the time of order dispatched.~~~</span>
    </marquee>
  </div>
</div>
<div class="topbar-divider-bg"style="padding-top:8px;"><marquee direction="left" onMouseOver="this.stop()" onMouseOut="this.start()">
     <span style="font-size:18px;font-family:Cooper Black; color:#c0504d;"></span>
    </marquee></div>
<header>
  <div class="header-inner">
    
    <div class="right" id="logo-hidden">
    <div class="logo"><a href="/index.php"><img src="<?=$site_url?>/img/logo.jpg" width="100%" alt="logo"></a></div>
      <div class="details">
	<span style="font-size:18px;font-family:Forte; color:#c0504d;"> 4 Delivery slots to choose from!!</span><br>
        ...
        <span style="font-size:20px;font-family:Cooper Black;color:orange;"> COD/Online Payments</span></div>
...
<span style="font-size:15px;color:orange;font-family:Cooper Black;">on all orders of Rs 299 and<br> Above.</span><br>
        <span style="color:#17365d;FONT-FAMILY:ARIAL; font-size:12px;"><B>Else add Rs.30/-<br>
...
Or Email Us @ <br>
orders@sabjionwheels.com<br>
        <span style="font-size:15px;font-family:Cooper Black; color:#9bbb59;">
...
<li><a href="<?=$site_url?>/Spices.php">SPICES</a></li>
          <li><a href="<?=$site_url?>/combooffers.php">COMBO OFFERS</a></li>
