...
*/
	...
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/custom.css', array('flexslider') );
...
function themonic_body_class( $classes ) {
	...
	if ( is_page_template( 'page-templates/full-width-no-comments.php' ) )
		$classes[] = 'full-width-no-comments';	
