...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="top"><strong>Contact Number:</strong></td>
  ...
  <tr>
    <td align="left" valign="top"><span style="text-align:left; padding-top:5px;">
      <label for="fscf_field1_3" style="text-align:left;"><strong>Address:</strong></label></span></td>
  ...
  <tr>
    <td align="left" valign="top"><strong>Call Back Time:</strong></td>
    <td align="left" valign="top"><label><?=$_POST['time']?></label></td>
  </tr>
</table>
<?
...
$sendmail='orders@sabjionwheels.com';
