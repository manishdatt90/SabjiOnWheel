...
<option value="11:00AM-3:00PM" <?=$shippingTimeSlot=='11:00AM-3PM'?'selected="selected"':''?>>11:00AM-3:00PM (Monday-Saturday)</option>
                       ...
                       <p><label style="width: 20%; float: left; padding-top: 2px;">COD</label><input type="radio" name="payment_option" id="cod" value="cod" checked="" style="float: left;"><label style="width: 20%; float: left; margin-left: 10px; padding-top: 2px;">Pay Online</label><input type="radio" style="float: left;" name="payment_option" id="cod" value="pay_online"></p>
                        </p> 
