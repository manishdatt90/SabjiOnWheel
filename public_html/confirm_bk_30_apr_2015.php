...
$totalPayableAmount1=($totalCartAmount1	+	$shippingCharge1);
...
if($_POST['pay_via'] == 'Pay Online' ) {
  $posted = array(
      ...
      "hash"=>'',
      "txnid"=>$order_id,
      "amount"=>$totalPayableAmountDisp1,
...
<tr>
                        ...
                        <input type="hidden" name="pay_via" value="<?= $payment_option ?>" />
                         ...
                         <form name="payuForm" method="post" action="<?php echo $form_action_pay_u; ?>">
                            ...
                            <input type="hidden" name="amount" value="<?php echo $totalPayableAmountDisp1; ?>" />
