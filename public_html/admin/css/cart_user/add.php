...
<head>
  ...
  <body>
	...
	<br />
 	 ...
 	 <tr>
	 <td>
    <form name="frmMyProfile" action="process_user.php" method="POST" onsubmit="javascript: return checkFrm();">
     ...
     <tr>				
    	...
    	<td>&nbsp;&nbsp;<? if($user_row->peopleEmail!='') echo $user_row->user_email;?></td>
     </tr>
	...
	<tr>
					<td>Active Status:</td>
					<td><input type="checkbox" name="online_status" value="1" <? echo (!empty($user_row->user_status) && $user_row->user_status==1)? 'checked="checked"' : ''; ?>></td>
				</tr>
